...
class WeightDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        $dataTable =  (new EloquentDataTable($query))
            ->addIndexColumn()
            ->editColumn('animal_id', function (Weight $model) {
                return $model->animal_name;
            });

        if (\Laratrust::hasPermission('weight show') || \Laratrust::hasPermission('weight edit') || \Laratrust::hasPermission('weight delete')) {
            $dataTable->addColumn('action', function (Weight $weight) {
                return view('dairy-cattle-management::weight.action', compact('weight'));
            });
            $rowColumn[] = 'action';
        }
    ...
    public function getColumns(): array
    {
        $column = [
            ...
            Column::make('date')->title(__('Date Recorded')),
            Column::make('age')->title(__('Age')),
            Column::make('weight')->title(__('Weight(Kgs)')),
        ];

        if (\Laratrust::hasPermission('weight edit') ||
            \Laratrust::hasPermission('weight delete') ||
            \Laratrust::hasPermission('weight show'))
        {
            $action = [
