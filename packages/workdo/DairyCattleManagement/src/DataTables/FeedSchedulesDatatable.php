...
class FeedSchedulesDatatable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        $dataTable = $dataTable->editColumn('scheduled_time', function ($row) {
            return company_datetime_formate($row->scheduled_time);
        });
        ...
        if (
            ...
            \Laratrust::hasPermission('feed schedule delete')
        ) {
    ...
    public function html(): HtmlBuilder
    {
        $dataTable = $this->builder()
            ->setTableId('feed_schedules-table')
    ...
    {
        return 'Feed_schedules_' . date('YmdHis');
    }
}
