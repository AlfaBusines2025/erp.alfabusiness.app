...
{{ Form::model($breeding, array('route' => array('breeding.update', $breeding->id), 'method' => 'PUT','enctype'=>'multipart/form-data','class'=>'needs-validation','novalidate')) }}
            ...
            <div class="tab-pane fade show active" id="tab-1" role="tabpanel">
                <div class="row">
                    ...
                    <div class="col-6 form-group">
                        ...
                        {{ Form::date('breeding_date', null, array('class' => 'form-control','placeholder'=>'Enter Breeding Date','required'=>'required')) }}
                    </div>
                    <div class="col-6 form-group">
