{{ Form::open(array('url' => 'birth_records', 'method' => 'post','class'=>'needs-validation','novalidate')) }}
            ...
            <div class="form-group col-12">
                ...
                <div class="row ms-1">
                    <div class="form-check col-md-6">
                        <input class="form-check-input gender" type="radio" name="gender" value="male" checked id="gender">
                        <label class="form-check-label" for="gender">
                            {{ __('Male') }}
                        </label>
                    </div>
                    <div class="form-check col-md-6">
                        <input class="form-check-input gender" type="radio" name="gender" value="female" id="gender">
                        <label class="form-check-label" for="gender">
                            {{ __('Female') }}
                        </label>
                    </div>
