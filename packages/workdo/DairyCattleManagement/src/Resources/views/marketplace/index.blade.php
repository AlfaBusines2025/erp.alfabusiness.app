...
@php
    $path = url("/packages/workdo/DairyCattleManagement/src/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="text-center section-title">
                <h2>{{__("Dairy Management Simplified: Dash SaaS")}}</h2>
                <p>{{__(" Dash SaaS streamlines dairy farm operations with intuitive tools for tracking animal health, milk production, and inventory, enabling farmers to optimize efficiency and profitability effortlessly.")}}</p>
            </div>
            <div class="row row-gap align-items-center padding-bottom ">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Animal Management')}}</h2>
                        </div>
                        <p>{{__("This module provides a user-friendly interface for managing your entire herd. Each animal has a detailed profile where you can record essential information such as health records, breeding history, and weight measurements. Our system also simplifies identification with unique animal tags and visual profiles, allowing you to quickly access the information you need for each individual animal.
            ...
            <div class="row row-gap align-items-center padding-bottom ">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Milk Production Tracking')}}</h2>
                        </div>
