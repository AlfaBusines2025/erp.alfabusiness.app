...
{{ Form::model($sales_distribution, array('route' => array('sales_distribution.update', $sales_distribution->id), 'method' => 'PUT','enctype'=>'multipart/form-data','class'=>'needs-validation','novalidate')) }}
