...
@php
    $path = url("packages/workdo/Calender/src/marketplace");
@endphp
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('Calendar is a unique approach to the classic event calendar concept. Fully responsive with modern design and  display your events in easy to read and navigate way. The plugin is packed with rich arsenal of features and options to help you create fully detailed and informative events quick and easy!')}}</p>
                        <div class="price">
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('You can use ')}}<b>{{__(' Calendar ')}}</b>{{__(' Show all Events')}}</h2>
                <p>{{__('The calendar with an event view makes it easier to keep a tab on important meetings.')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Calendar Helps You Simplify Your Work')}}</h2>
                        </div>
                        ...
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Calendar syncing feature helps to schedule meetings')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('The zoom meeting created will be synced with the calendar which will show the meeting details, as well as which are people joining the meeting and at what time. This calendar syncing feature helps to schedule meetings accordingly.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Task Management')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Get a calendar view for every task detail. In short, managing task has never been easier with the calendar of task visibility in the system.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('What are Event Calendars?')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('An event calendar is a design pattern that allows the user to select a date. The dates are not presented as a traditional list that a user scrolls through, or as input fields where the user enters numbers, but rather as a visual representation of a monthly calendar.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Speed up the User’s Process by Adding an Event Calendar')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Users are impatient creatures: anything that may seem like an inefficient course of action to achieve the goals they have they will regard as suboptimal and take a dim view of.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Why Choose an Event Calendar Design Pattern?')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Allowing users to select a date from a list—rather than input the information manually— saves them time and effort. A user might be trying to submit a date, track an order, arrange content according to a specific range of dates, or filter results.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('The Take Away')}}</h2>
                        </div>
                        <p>{{__('Event calendars are a great visual way of letting the user enter a date or date range. When implementing event calendars, you need to take into consideration that date formats differ across cultures. Also, you should help the user out by presenting dates that are closest to the present.')}}</p>
                    </div>
                </div>
            </div>
        </div>
